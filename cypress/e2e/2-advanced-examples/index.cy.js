...
describe('Carga la página principal', () => {
    ...
    it('Prueba el Bloque de Contacto', () => {
        ...
        cy.get('[data-cy="imagen-contacto"]').find('p').invoke('text').should('equal', 'Rellena el formulario de contacto y un asesor comercial se pondrá en contacto contigo lo antes posible');
    ...
    it('Prueba las reseñas y el Blog (estático)', () => {
        ...
        cy.get('[data-cy="reseñas"]').should('exist');
        cy.get('[data-cy="reseñas"]').find('h3').invoke('text').should('equal', 'Reseñas');
        cy.get('[data-cy="reseñas"]').find('h3').invoke('text').should('not.equal', 'Nuestras reseñas');
